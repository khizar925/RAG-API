...
#     # ChromaDB crashes if no documents match the filter,
#     # so we wrap it in a try/except to handle that gracefully.
#     try:
...
#     except Exception:
#         # No documents exist yet for this chat — that's fine, context stays empty
#         context = ""

#     # Build the prompt differently depending on whether we have context
#     if context:
#         prompt = f"Context:\n{context}\n\nQuestion: {q}\n\nAnswer clearly and concisely based on the context above:"
#     else:
#         # No file uploaded — just answer the question directly
